...
import ss1 from "../../assets/ss1 (2).png";
...
export default function LabAccordion() {
  ...
  return (
    ...
    <div className="accordionContainer bodyText">
        ...
        <img src={ss1} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        ...
        <img src={ss2} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <br/>
        ...
        <img src={ss3} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <img src={ss4} className="imgstyle" style={{borderRadius:30}}  alt=" "></img>
        <br/>
        ...
        <img src={ss3} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <img src={ss5} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <img src={ss6} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <br/>
        ...
        <br/>
        <img src={ss7} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <hr /><br/>
        ...
        <img src={ss8} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <br/>
        <h3 className="steps">Step 3:</h3>
        <br/>
        ...
        <img src={ss10} className="imgstyle" style={{borderRadius:30,height: 310}} alt=" "></img>
        ...
        <img src={ss9} className="imgstyle" style={{borderRadius:30 , height: 310}} alt=" "></img>
        <br/>
        <h3 className="steps">Step 4:</h3>
        <br/>
        ...
        <img src={ss11} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
        <br/>
        <h3 className="steps">Step 5:</h3>
        <br/>
        ...
        <img src={ss12} className="imgstyle" style={{borderRadius:30}} alt=" "></img>
