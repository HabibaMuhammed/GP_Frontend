    ...
    <div className="sideBar">
      ...
      >
        <Menu>
          ...
          <MenuItem
            icon={<HomeOutlinedIcon sx={{ color: grey[500] }} />}
            onClick={Tohomeclick}
          >
            Home
          </MenuItem>
          <MenuItem
            bgcolor="black"
            icon={
              <AccountCircle sx={{ color: grey[500] }} onClick={toProfile} />
            }
          >
            Profile
          </MenuItem>
          ...
          <MenuItem
            icon={
              <TuneOutlined sx={{ color: grey[500] }} onClick={toSettings} />
            }
          >
            Settings
          </MenuItem>
          <MenuItem
            icon={<LogoutOutlined sx={{ color: grey[500] }} />}
